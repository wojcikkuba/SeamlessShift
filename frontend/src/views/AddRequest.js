    ...
    if (selectedSubjects.length > 0) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.error(
            "Dodawanie prośby nie powiodło się. Spróbuj ponownie później."
          );
        }
      } catch (error) {
      ...
      console.log(
        "Wybierz przynajmniej jeden przedmiot przed dodaniem prośby."
      );
    }
  };
          ...
          <Col xs={12}>
            <Card>
              ...
              <CardBody>
                ...
                {successMessage && (
                  <p className="text-info h4 text-center">{successMessage}</p>
                )}
              </CardBody>
            </Card>
          </Col>
