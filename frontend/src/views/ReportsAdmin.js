...
function ReportsAdmin() {
    ...
    const [usersList, setUsersList] = useState([]); // Lista użytkowników dla administratora
    ...
    useEffect(() => {
        // Pobierz listę użytkowników dla administratora
        fetchUsersList();
      }, []);
    ...
    const handleDownloadReport = () => {
        if (selectedUser && startDate && endDate && reportData) {
          ...
          const exportData = [
            ["Imię", "Nazwisko", "E-mail", "Data początkowa", "Data końcowa", "Liczba zgłoszonych prośb", "Liczba podjętych zastępstw", "Liczba odpowiedzi na zgłoszenia użytkownika"],
            [selectedUser.firstName, selectedUser.lastName, selectedUser.email, formatDate(startDate), formatDate(endDate), reportData.userRequestsCount, reportData.userReplacementsCount, reportData.answeredRequestsCount],
          ];
